...
| Main Hero |
| --- |
| ![Mneme main hero](../assets/mneme-hero.png) |

| Shared Memory Layer | Cross-Chat Continuity |
| --- | --- |
| ![Shared Memory Layer](../assets/docs/shared-memory-layer.png) | ![Cross-Chat Continuity](../assets/docs/cross-chat-continuity.png) |

| Local-First Store | Recall Search |
| --- | --- |
| ![Local-First Store](../assets/docs/local-first-store.png) | ![Recall Search](../assets/docs/recall-search.png) |
